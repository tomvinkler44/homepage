        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 hero-text-shadow">
              Wanna know why? Because relying on the job boards to get a job in 2025 is like relying on a lottery ticket to fix the low balance on your bank account. Sure, could work, but...
            </p>
            <div className="flex items-center gap-8">
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="bg-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-orange-600 transition action-button-glow"
              >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="video-button flex items-center justify-center transition-all duration-300"
              >
