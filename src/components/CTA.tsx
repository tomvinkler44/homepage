  ...
  return (
    <div className="bg-[#1a365d] py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          While you're spending hours sending applications into the void, other job seekers are 
          landing interviews using proven strategies that actually work. Isn't it time to learn 
        ...
        >
          <motion.button 
            ...
            whileHover={{ scale: 1.05, boxShadow: "0 25px 50px -12px rgba(234, 88, 12, 0.25)" }}
            whileTap={{ scale: 0.95 }}
          >
          ...
          <motion.button 
            className="bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
